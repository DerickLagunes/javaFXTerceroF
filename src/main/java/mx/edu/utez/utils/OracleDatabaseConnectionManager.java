...
public class OracleDatabaseConnectionManager {
    private static final String WALLET = "C:/Users/Derick/Desktop/wallet3f";
    private static final String DB_NAME = "tercerofpoo_high";
    private static final String DB_URL = "jdbc:oracle:thin:@" + DB_NAME + "?TNS_ADMIN=" + WALLET;
    private static final String DB_USER = "ADMIN";
    private static final String DB_PASSWORD = "MGsj9NSVsKzyyGg";
